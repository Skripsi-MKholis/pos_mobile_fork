              ...
              children: [
                RefreshIndicator(
                  ...
                  child: productsAsync.when(
                    data: (products) {
                      // Optimization: Hoist invariant search query lowercase conversion outside the loop
                      // to prevent redundant O(N) memory allocations and computations on every iteration.
