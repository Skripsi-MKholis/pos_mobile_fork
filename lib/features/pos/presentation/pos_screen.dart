              ...
              children: [
                RefreshIndicator(
                  ...
                  child: productsAsync.when(
                    data: (products) {
                      // ⚡ Bolt: Hoisted lowercase conversion outside loop and added fast path to prevent O(N) redundant allocations.
                      ...
                      var filteredProducts = products.where((p) {
                        ...
                        if (queryLowerCase.isEmpty) return true;

                        return p.name.toLowerCase().contains(queryLowerCase) ||
