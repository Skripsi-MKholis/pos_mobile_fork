  ...
  void _handleSearchSubmitted(String value, List<Product> products) {
    ...
    if (foundProduct != null) {
      ...
      mySnackBar(
        context: context,
        text:
            AppLocalizations.of(context)!.productAddedToCart(foundProduct.name),
                              ...
                              onTap: () async {
                                if (isOccupied) {
                                  ...
                                  if (confirmed == true) {
                                    ...
                                    final monitoring =
                                        ref.read(tableMonitoringProvider).value;
                ...
                if (cartItems.isNotEmpty)
                  Positioned(
                    ...
                    child: _buildCartSummary(
                        context, cartNotifier, currencyFormat),
                  ),
              ],
            ),
          ),
                ...
                child: ShadIconButton.outline(
                  onPressed: () async {
                    final confirmed = await showShadDialog<bool>(
                      context: context,
                      builder: (context) => ShadDialog(
                        title: Text(l10n.confirmClearCart),
                        description: Text(l10n.confirmClearCartDesc),
                        actions: [
                          ShadButton.outline(
...
class _BarcodeScannerModalState extends State<_BarcodeScannerModal>
  ...
  void _onDetect(BarcodeCapture capture) {
    ...
    if (foundProduct != null) {
      ...
      _showNotification(
          AppLocalizations.of(context)!.skuNotRegistered(barcodeValue), false);
    }
  }
