              ...
              child: productsAsync.when(
                data: (products) {
                  ...
                  final isUncategorized =
                      widget.category.supabaseId == 'uncategorized';
                  final categoryId = widget.category.supabaseId;
                  final queryLower = _searchQuery.toLowerCase();

                  final filtered = products.where((p) {
                    // Evaluate cheap category match first
                    final isInCategory = isUncategorized
                        ? p.categoryId == null
                    ...
                    if (pNameLower.contains(queryLower)) return true;

                    if (p.sku != null) {
                      final pSkuLower = p.sku!.toLowerCase();
                      if (pSkuLower.contains(queryLower)) return true;
                    }
