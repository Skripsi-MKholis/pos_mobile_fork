...
class ReportsScreen extends ConsumerWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    analyticsAsync.when(
                      data: (state) => _buildAnalyticsContent(state, currencyFormat, theme),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const Icon(TablerIcons.sparkles, color: Colors.black, size: 28),
                ),
  ...
  Widget _buildAnalyticsContent(AnalyticsState state, NumberFormat format, ShadThemeData theme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildStatsGrid(AnalyticsState state, NumberFormat format, ShadThemeData theme) {
    return Row(
      children: [
        Expanded(
            ...
            bottomTitles: AxisTitles(
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (val, meta) {
                  if (val.toInt() >= 0 && val.toInt() < state.dailySales.length) {
                    return Padding(
                      padding: const EdgeInsets.only(top: 8.0),
                      child: Text(
                        state.dailySales[val.toInt()]['date'],
                        style: TextStyle(color: theme.colorScheme.mutedForeground, fontSize: 10),
                      ),
                    );
                  }
          ...
          lineBarsData: [
            LineChartBarData(
              ...
              belowBarData: BarAreaData(
                show: true,
                gradient: LinearGradient(
                  colors: [Warna.primary.withOpacity(0.3), Warna.primary.withOpacity(0.0)],
  ...
  Widget _buildProductItem(Map<String, dynamic> p, NumberFormat format, ShadThemeData theme) {
    return Container(
      margin: const EdgeInsets.only(bottom: 12),
      padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 12),
      decoration: BoxDecoration(
        border: Border(bottom: BorderSide(color: theme.colorScheme.border.withOpacity(0.3))),
      ),
      child: Row(
        children: [
          Expanded(
